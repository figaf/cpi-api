...
abstract class MessageProcessingLogAbstractClient extends CpiBaseClient {
    ...
    protected static final String PAGINATION_SORT_FILTER_TEMPLATE = "$inlinecount=allpages&$format=json&$top=%d&$skip=%d&$orderby=LogEnd desc&$filter=%s";

    protected static final String PAGINATION_SORT_FILTER_SELECT_TEMPLATE = "$inlinecount=allpages&$format=json&$top=%d&$skip=%d&$orderby=LogEnd desc&$filter=%s&$select=%s";

    protected static final String SORT_FILTER_LIMIT_TEMPLATE = "$inlinecount=allpages&$format=json&$top=%d&$orderby=LogEnd&$filter=%s";
    ...
    protected static final String FILTER_TEMPLATE = "$format=json&$filter=%s";
